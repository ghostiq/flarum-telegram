...
/***/ "./src/admin/components/TelegramSettingsModal.js":
/*!*******************************************************!*\
  !*** ./src/admin/components/TelegramSettingsModal.js ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TelegramSettingsModal; });
...
var settingsPrefix = 'flagrow-telegram.';
var translationPrefix = 'flagrow-telegram.admin.settings.';

var TelegramSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(TelegramSettingsModal, _SettingsModal);

  function TelegramSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = TelegramSettingsModal.prototype;
  ...
  _proto.form = function form() {
    return [m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'field.botUsername')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'botUsername'),
      placeholder: 'SampleBot'
    })]), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'field.botToken')), m('input.FormControl', {
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'field.enableNotifications')
    }))])];
  };
...
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_TelegramSettingsModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/TelegramSettingsModal */ "./src/admin/components/TelegramSettingsModal.js");



flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flagrow-telegram', function (app) {
  app.extensionSettings['flagrow-telegram'] = function () {
    return app.modal.show(new _components_TelegramSettingsModal__WEBPACK_IMPORTED_MODULE_2__["default"]());
  };
});
